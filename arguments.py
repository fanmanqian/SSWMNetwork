...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--id', default='0427-face-random-debug',
                            help="a name for identifying the model")
        parser.add_argument('--num_mix', default=2, type=int,
                            help="number of sounds to mix")
        parser.add_argument('--arch_sound', default='unet6',
                            help="architecture of net_sound")
        parser.add_argument('--arch_frame', default='vggface',
        ...
        parser.add_argument('--stride_frames', default=8, type=int,
        ...
        parser.add_argument('--store_path',
                            default='/F/time-frequency/av/att-unet-dyrelu/result', type=str,
                            help="store_path")
        ...
        parser.add_argument('--num_val', default=1200, type=int,
                            help='number of images to evalutate')
        parser.add_argument('--num_vis', default=40, type=int,
                            help='number of images to evalutate')

        parser.add_argument('--audLen', default=51100, type=int,
                            help='sound length')
        ...
        parser.add_argument('--stft_win', default=400, type=int,
                            help="stft hop length")
    ...
    def add_train_arguments(self):
        ...
        parser.add_argument('--list_train',
                            default='data/final_tcdtimit_train_random_face.csv')
        parser.add_argument('--list_val',
                            default='data/final_tcdtimit_test_random_face.csv')
