...
from .vision_net import ResnetFC, ResnetDilated, VGGFace
from .criterion import BCELoss, L1Loss, L2Loss
from models.submodule import vgg_face_dag
...
class ModelBuilder():
    ...
    def build_frame(self, arch='resnet18', fc_dim=64, pool_type='avgpool',
        ...
        if arch == 'resnet18fc':
            ...
            original_vggface = vgg_face_dag('../vgg_face_dag.pth')
            net = VGGFace(original_vggface, fc_dim=fc_dim, pool_type=pool_type)
        else:
            raise Exception('Architecture undefined!')
